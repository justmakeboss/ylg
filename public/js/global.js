...
{	   	
	var upurl ='/index.php?m=Admin&c=Ueditor.Uploadify&a=upload&num='+num+'&input='+elementid+'&path='+path+'&func='+callback;
    layer.open({
        type: 2,
        title: '上传图片',
        shadeClose: true,
...
{	   	
	var upurl ='/index.php?m=Home&c=Ueditor.Uploadify&a=upload&num='+num+'&input='+elementid+'&path='+path+'&func='+callback;
    layer.open({
        type: 2,
        title: '上传图片',
        shadeClose: true,
...
function get_repair(id,next,select_id){
    var url = '/index.php?m=Home&c=api&a=get_repair&parent_id='+ id;
    $.ajax({
        type : "GET",
        url  : url,
        error: function(request) {
...
function showMsg(msg,color){
    ...
    // $.toptip(msg, 2000, color); 
}
function showErrorMsg(msg){
    // layer.open({content:msg,time:2});
    layer.open({content:msg,time:2});
    // $.toptip(msg, 2000, 'error'); 
}
function showSuccessMsg(msg){
    // layer.open({content:msg,time:2});
    // $.toptip(msg, 2000, 'success'); 
    layer.open({content:msg,time:2});
}
