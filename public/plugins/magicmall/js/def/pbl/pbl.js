	 ...
	 */
		$(function(){
				...
				function tores(){
					var tmpWid=$(".pbl-warp").width();
					var column=Math.floor(tmpWid/370);
						tmpWid=column*370;
						...
						(function(sqlJson){
							...
							if(itemNum>30){
								...
								for(var i in sqlJson){
									...
									html+="<div class='b-act'>";
									html+="<a href='javascript:;'><i class='icon icon-edit'></i></a><a href='javascript:;'><i class='icon icon-trash'></i></a></div>";
									html+="</li>";		
								}
								/*模拟ajax请求数据时延时800毫秒*/
