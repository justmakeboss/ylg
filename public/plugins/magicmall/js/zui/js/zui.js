...
(function($, window) {
    ...
    ModalTrigger.prototype.init = function(options) {
        ...
        $modal = $('<div id="' + options.name + '" class="modal modal-trigger">' + (typeof options.loadingIcon === 'string' && options.loadingIcon.indexOf('icon-') === 0 ? ('<div class="loader" style="min-width: 180px;font-size:0px"><i class="icon icon-spin ' + options.loadingIcon + '" style="font-size:56px"></i><div><span style="font-size:18px;margin-left:15px">' + options.content+'</span></div></div>') : options.loadingIcon) + '<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button class="close" data-dismiss="modal">×</button><h4 class="modal-title"><i class="modal-icon"></i> <span class="modal-title-name"></span></h4></div><div class="modal-body"></div></div></div></div>').appendTo('body').data(NAME, that);
...
(function($, window, undefined) {
    ...
    var id = 0;
    var template = '<div class="messager messager-{type} {placement}" style="display: none;border-radius:5px"><div class="messager-content"></div><div class="messager-actions"></div></div>';
    var defaultOptions = {
        type: 'default',
        placement: 'top',
        time: 4000,
