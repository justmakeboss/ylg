...
//                        dump($consignment[$i]['id']);
//                        dump($agentdata['order_id']);exit;
...
//                        dump($consignment[$i]['num']);
//                        dump($agentdata['sell_num']);
...
//                        dump($goods_integral);exit;
                ...
                // ->Inc('distribut_money',$order['goods_price']*$system['goods_integral'])
            }else{
                    //自营
