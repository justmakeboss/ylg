...
//        '2'=>array('用户找回密码','验证码${code}，用于密码找回，如非本人操作，请及时检查账户安全','forget_pwd_sms_enable'),
        ...
        //短信使用场景
    'SEND_MSG' => array(
        '1'=>array('推荐下级消息','恭喜您的好友 $nickname 成为智慧术网红粉丝$rn时间：$add_time','extend_template_msg_enable'),
        '2'=>array('下级下单消息','您下级粉丝$nickname已成功购买了$goods, 您的佣金为$distribut_money, 订单号:$order_sn $rn时间：$add_time','lower_buy_msg_enable'),
        '3'=>array('身份升级本人消息','恭喜您成为智慧术网红$level $rn时间：$add_time','update_level_oneself_msg_enable'),
